...
export function Create() {
  ...
  const events = [
    ...
    { event: EVENT_SENT_INVOICE, label: t('invoice_sent_notification_label') },
    ...
    { event: EVENT_SENT_QUOTE, label: t('quote_sent') },
    ...
    { event: EVENT_PROJECT_CREATE, label: t('create_project') },
    { event: EVENT_PROJECT_UPDATE, label: t('update_project') },
    { event: EVENT_PROJECT_DELETE, label: t('delete_project') },
    ...
    { event: EVENT_SENT_CREDIT, label: t('credit_sent') },
    ...
    { event: EVENT_SENT_PURCHASE_ORDER, label: t('purchase_order_sent') },
